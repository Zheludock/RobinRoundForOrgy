...
class Script4 extends UserScript {
    public Script4() {
        this.name = "Script4";
    }

    public boolean run() {
        // Логика выполнения Script4
        System.out.println("Running Script4...");
        return true;
    }
}
...
class Script5 extends UserScript {
    ...
    public boolean run() {
        // Логика выполнения Script5
        System.out.println("Running Script5...");
        return true;
    }
}